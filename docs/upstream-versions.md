...
|-----------|-------------|----------|---------------|---------------|
| **llm-d** | `v0.6.0` | CI release ref | `.github/workflows/ci-e2e-openshift.yaml`, `.github/workflows/ci-pr-checks.yaml` (`LLM_D_RELEASE`) | [llm-d/llm-d](https://github.com/llm-d/llm-d) |
